...
\begin{tikzpicture}[x=0.72cm,y=0.72cm,
    ...
    \node[above=1mm, font=\scriptsize] at (a) {$I_\ini$};
    \node[below=1mm, font=\scriptsize] at (g) {$I_\tar$};
    \node[below=1mm, font=\scriptsize] at (h) {farthest};
\end{tikzpicture}\\[-1mm]
{\small Solution-space graph (blue: shortest path, orange: farthest path)}
\end{minipage}
\caption{A CoRe Challenge 2023 instance with $|I_\ini|=3$.
